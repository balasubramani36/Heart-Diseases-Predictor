...
for z in range(3000):
    ...
    write_data = open(
    'C:/Users/ImmaTech/Downloads/Heart_ECG/Dataset/Final.csv', 'w')
    out = csv.writer(write_data)
    out.writerows(map(lambda x: [x], fbtod))
    write_data.close()

read_data = np.loadtxt(
    'C:/Users/ImmaTech/Downloads/Heart_ECG/Dataset/Final.csv')
sf = 100.
...
sns.despine()
writer_val = tf.summary.FileWriter('C:/Users/ImmaTech/Downloads/Heart_ECG/log/dataset_ecg')
writer_train =tf.summary.FileWriter('C: / Users/ImmaTech/Downloads/Heart_ECG/log/normalization_ecg')
